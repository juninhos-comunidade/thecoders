...
export default function ProfileIcon() {
	...
	const handleSair = () => {
		...
		// Mostra a mensagem de despedida por um instante antes de redirecionar
		setTimeout(() => {
			localStorage.clear();
	...
	return (
		<div className="profile-icon-container" ref={containerRef}>
			<button
			...
			{menuAberto && !saindo && (
				<div className="profile-icon-menu">
					<button
						type="button"
						className="profile-icon-menu__item profile-icon-menu__item--sair"
						onClick={handleSair}
					>
						Sair
					</button>
			...
			{saindo && (
				<div className="profile-icon-menu profile-icon-menu--despedida">
					<p>Até a próxima! 👋</p>
				</div>
			)}
		</div>
